...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.my_vpiTitlePageIndicatorStyle);
    }
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.my_TitlePageIndicator, defStyle, 0);

        //Retrieve the colors to be used for this view and apply them.
        mFooterLineHeight = a.getDimension(R.styleable.my_TitlePageIndicator_my_footerLineHeight, defaultFooterLineHeight);
        mFooterIndicatorStyle = IndicatorStyle.fromValue(a.getInteger(R.styleable.my_TitlePageIndicator_my_footerIndicatorStyle, defaultFooterIndicatorStyle));
        mFooterIndicatorHeight = a.getDimension(R.styleable.my_TitlePageIndicator_my_footerIndicatorHeight, defaultFooterIndicatorHeight);
        mFooterIndicatorUnderlinePadding = a.getDimension(R.styleable.my_TitlePageIndicator_my_footerIndicatorUnderlinePadding, defaultFooterIndicatorUnderlinePadding);
        mFooterPadding = a.getDimension(R.styleable.my_TitlePageIndicator_my_footerPadding, defaultFooterPadding);
        mLinePosition = LinePosition.fromValue(a.getInteger(R.styleable.my_TitlePageIndicator_my_linePosition, defaultLinePosition));
        mTopPadding = a.getDimension(R.styleable.my_TitlePageIndicator_my_topPadding, defaultTopPadding);
        mTitlePadding = a.getDimension(R.styleable.my_TitlePageIndicator_my_titlePadding, defaultTitlePadding);
        mClipPadding = a.getDimension(R.styleable.my_TitlePageIndicator_my_clipPadding, defaultClipPadding);
        mColorSelected = a.getColor(R.styleable.my_TitlePageIndicator_my_selectedColor, defaultSelectedColor);
        mColorText = a.getColor(R.styleable.my_TitlePageIndicator_android_textColor, defaultTextColor);
        mBoldText = a.getBoolean(R.styleable.my_TitlePageIndicator_my_selectedBold, defaultSelectedBold);

        final float textSize = a.getDimension(R.styleable.my_TitlePageIndicator_android_textSize, defaultTextSize);
        final int footerColor = a.getColor(R.styleable.my_TitlePageIndicator_my_footerColor, defaultFooterColor);
        ...
        Drawable background = a.getDrawable(R.styleable.my_TitlePageIndicator_android_background);
        if (background != null) {
