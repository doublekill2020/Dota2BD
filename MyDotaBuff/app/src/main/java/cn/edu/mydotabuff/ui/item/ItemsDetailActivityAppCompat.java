 ...
 * @author tupunco
 */
public class ItemsDetailActivityAppCompat extends AppCompatFragmentActivity {

    private static final String TAG = "ItemsDetailActivityAppCompat";
    /**
     * 物品名称 Intent 参数
     */
     ...
     */
    public final static String KEY_ITEMS_DETAIL_PARENT_KEY_NAME =
            "KEY_ITEMS_DETAIL_PARENT_KEY_NAME";
    ...
    public static class ItemsDetailFragment extends Fragment implements
         ...
         * 物品详细 LoaderTask
         */
        private final AsyncTask<String, Void, ItemsItem> mLoaderTask = new AsyncTask<String,
                Void, ItemsItem>() {
            @Override
